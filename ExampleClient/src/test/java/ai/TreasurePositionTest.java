...
class TreasurePositionTest {

	@Test
	void createMap_searchForTreasurePosition_hasFoundTheCorrectPoint() {
		...
		Point p = positionFinding.getTreasurePosition();

		Assertions.assertTrue(p == p10);
	}
